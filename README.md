...
| Nuclear isomer, deuteron binding, alpha/beta carrier census, fusion barriers and resonance map on the shared Δ-ruler | [Analysis_hQVM_CGM_Trestleboard](docs/Findings/Analysis_hQVM_CGM_Trestleboard.md) | [hqvm_cgm_trestleboard_run.py](experiments/hqvm_cgm_trestleboard_run.py) (`_1.py`–`_4.py`, [results](experiments/hqvm_cgm_trestleboard_results.txt)) |
