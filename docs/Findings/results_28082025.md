...
The stage progression CS→UNA→ONA→BU exhibits the prescribed gyration patterns, with left and right gyrations activating and deactivating as theoretically required. The BU amplitude threshold  m_a = 1/(2√(2π)) emerges correctly from the closure constraint.
...
(.venv) PS D:\Development\CGM> & d:/Development/CGM/.venv/Scripts/python.exe d:/Development/CGM/experiments/hqvm_gravity_analysis_1.py
...
GEOMETRY-ONLY INVARIANTS:
  δ_BU = 0.195342 rad (ratio to m_a: 0.979)
...
Testing Lemma UNA: Unity is Non-Absolute
==================================================
...
Testing Lemma ONA: Opposition is Non-Absolute    
=======================================================     
...
Testing Lemma BU: Balance is Universal
==================================================
...
📝 INTERPRETATION:
   ...
   No claim about mechanism yet; the data currently show only selection bias.    
...
BU Dual-Pole Loop Constant:
  δ_BU = 4·arctan(k(π/4)·k(m_a)) ≈ 0.195342178258 rad
  BU threshold  m_a ≈ 0.199471140200
  Ratio δ_BU/ m_a ≈ 0.979300454497
  Deviation from 1.0: 2.07%
...
⚠️  χ is VARIABLE: May need additional conditions
...
3. **surplus Closure**: The 97.93% closure (toroidal holonomy deficit 0.863 rad) creates interference
