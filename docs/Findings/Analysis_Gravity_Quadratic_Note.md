...
*Reproducibility.* All numerical results are generated by `experiments/hqvm_gravity_analysis_8.py` through `hqvm_gravity_analysis_10.py` in the archived repository [7]. The kernel invariants cited above are verified by exhaustive enumeration of the 4,096-state space.
...
[8] B. Korompilias, Gyroscopic ASI hQVM Kernel Specification (2025).
