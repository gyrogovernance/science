...
**Document Type:** Structural Analysis  
...
This value is derived from the CGM invariants, specifically the BU holonomy defect and the aperture scale fixed by the horizon constraint. It represents the structural equilibrium at which a governance system is neither rigidly over-determined nor chaotically under-determined.
