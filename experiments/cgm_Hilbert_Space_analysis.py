...
# Define U_R as rotation (preserves constant function - CS1)
# Choose rotation by π about x-axis (order 2, ensures depth-four closure)
ROT_SEQ = 'XYZ'
angles_R = (np.pi, 0.0, 0.0)

# Define U_L as phase multiplication (alters constant function - CS2)
...
# ============================================================================
# 4. VERIFY AXIOM CS1 (RIGHT PRESERVATION)
# ============================================================================

print("4. AXIOM CS1: RIGHT PRESERVATION [R]S <-> S")
print("-" * 80)
...
print("CS1 verified: Right transition preserves horizon constant")
print()

# ============================================================================
# 5. VERIFY AXIOM CS2 (LEFT ALTERATION)
# ============================================================================

print("5. AXIOM CS2: LEFT ALTERATION ~([L]S <-> S)")
print("-" * 80)
...
print("CS2 verified: Left transition alters horizon constant")
print()

# ============================================================================
# 6. VERIFY DEPTH-TWO NON-COMMUTATION (CS3, CS5)
# ============================================================================

print("6. DEPTH-TWO NON-COMMUTATION (CS3, CS5)")
print("-" * 80)
...
if not (norm_diff > eps_comm):
    ...
    print()
    print("CS3, CS5 verified: Two-step compositions do not commute absolutely")
print()

# ============================================================================
# 7. VERIFY DEPTH-FOUR COMMUTATION (CS7)
# ============================================================================

print("7. DEPTH-FOUR COMMUTATION (CS7: []B)")
print("-" * 80)

# Apply U_L U_R U_L U_R (on cyclic vector for CS7 check)
...
if norm_diff_4 < eps_depth4:
    print(f"\nCS7 verified: Four-step compositions commute on horizon sector (Omega)")
...
print("Joint spectrum constraints from CS7:")
...
results = {
    ...
    'observables': ['T', 'V', 'A', 'B'],
    'completeness': True,
    'axioms_verified': ['CS1', 'CS2', 'CS3', 'CS5', 'CS7'],
...
print(f"  Axioms verified in this experiment: CS1, CS2, CS3, CS5, CS7")
print()
