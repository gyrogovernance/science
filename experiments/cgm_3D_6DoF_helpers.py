...
from modal conditions, WITHOUT assuming unitarity or Hilbert space representations.
...
logical conditions before introducing any representation theory.
...
print("=" * 80)
print()
print("Approach: Derive Lie algebra structure from modal conditions")
...
if SYMPY_AVAILABLE:
    ...
    # Degree 3 and higher: nested commutator conditions
    print("  Degree 3+: Nested commutator conditions")
...
print("the conditions force the Lie algebra generated by X, Y to satisfy:")
print()
print("  [X,[X,Y]] = a*Y")
print("  [Y,[X,Y]] = -a*X")
print()
...
print("           PURELY from modal conditions. The representation choice")
