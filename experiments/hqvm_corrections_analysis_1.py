#!/usr/bin/env python3
"""
hqvm_corrections_analysis_1.py
...
def main() -> None:
    ...
    print(
        "CGM birefringence Δn = (α/4π)*(B/B_crit)²*C_IDE*K_QG/(4π):", f"{delta_n:.12e}"
    )
    ...
    print(
        "CGM prediction accuracy:",
        f"{abs(dark_matter_fraction - Decimal('0.27'))/Decimal('0.27')*100:.1f}%",
    )
